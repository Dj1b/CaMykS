<?php
    ...
    global $API_UserName, $API_Password, $API_Signature, $API_Endpoint, $PAYPAL_URL;
    global $sBNCode, $version;
	...
	********************************************/
	...
	//require('paypal_config.php'); //Now made by CaMykS input
	...
	*/
	function CallShortcutExpressCheckout( $paramsArray, $returnURL, $cancelURL) 
	{
		...
		if(isset($paramsArray["L_PAYMENTREQUEST_0_TAXAMT0"]))
		$nvpstr = $nvpstr . "&L_PAYMENTREQUEST_0_TAXAMT0=" . $paramsArray["L_PAYMENTREQUEST_0_TAXAMT0"];
