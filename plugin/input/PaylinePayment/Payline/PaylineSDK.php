...
class PaylineSDK
{
     ...
     */
    public function __construct($merchant_id, $access_key, $proxy_host, $proxy_port, $proxy_login, $proxy_password, $environment, $pathLog = null, $logLevel = 200, $externalLogger = null, $defaultTimezone = "Europe/Paris")
    {
