...
SiteMonitoringToolbar.set_locale('startbench', 'Start page benchmark');
SiteMonitoringToolbar.set_locale('displaybench', 'Display page benchmark');

SiteMonitoringToolbar.set_locale('reloadpage', 'Refresh page');

SiteMonitoringToolbar.set_locale('displayconfiguration', 'Display configuration');
...
SiteMonitoringToolbar.set_locale('formlabel_appliedtheme', 'Applied theme: ');

SiteMonitoringToolbar.set_locale('save', 'Save');